...
const ab1 = await db.query("SELECT TOP 3 gang_code, total_upah_kotor FROM dbo.daftar_upah_aggregation_history WHERE division_code='AB1' AND period_month=7 ORDER BY gang_code");
console.log("AB1 sample " + JSON.stringify(ab1));
