...
import { Banknote, BarChart3, TrendingUp, Receipt, HeartPulse, Check } from 'lucide-react';
                ...
                <div className="agg-left-pane">
                    ...
                    <div className="sync-card-grid">
                        {SYNC_TYPES.map(type => (
                            ...
                            >
                                <div className="sync-icon"><type.Icon size={28} /></div>
                                <div className="sync-info">
                                    <h4>{type.title}</h4>
                                    <p>{type.description}</p>
                                </div>
                                {syncType === type.id && <div className="sync-check"><Check size={16} /></div>}
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="sync-instructions" style={{ padding: '0 1rem', color: '#64748b', fontSize: '0.9rem' }}>
                        <p><strong>Current Sync:</strong> {syncType === 'DAFTAR_UPAH' ? 'Daftar Upah Lengkap' : syncType === 'ANALISIS_PAYROLL' ? 'Daftar Upah + Analisis Lembur & Premi' : syncType === 'SUMMARY_WAGES' ? 'Wages Summary Report' : syncType}</p>
